...
public class GenerationFromages {
	...
	public static List<Fromage> getFromageBrebis(){
		return GenerationFromageBrebis();
	}
	
	public static List<Fromage> getFromageChèvre(){
		return GenerationFromageChèvre();
	}
	
	public static List<Fromage> getFromageVache(){
		return GenerationFromageVache();
	}
	
	public static List<Fromage> getTousFromages(){
		List<Fromage> tousFromage = new LinkedList<>();
		tousFromage.addAll(getFromageVache());
		tousFromage.addAll(getFromageChèvre());
		tousFromage.addAll(getFromageBrebis());
		return tousFromage;
	}
